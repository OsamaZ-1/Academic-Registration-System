<tr>
    <th colspan="6" align="center" class="table-title">Semester <?php echo $temp_course_sem;?>  Grades</th>
</tr>
<tr>
    <th class="attributes">Course Code</th>
    <th class="attributes">Course Name</th>
    <th class="attributes">Credits</th>
    <th class="attributes">Sess 1</th>
    <th class="attributes">Sess 2</th>
...
<tr>
    ...
    <td><?php echo $c["SessionOne"]; ?></td>
    <td><?php echo $c["SessionTwo"]; ?></td>
...
?>
<tr>
    <th colspan="6" align="center" class="table-title">Optional Courses</th>
</tr>
<?php
