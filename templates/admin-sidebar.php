<div class="slidebar sticky-top openSide" id="slide_nav">
    ...
    <ul class="list-unstyled px-3">
        <!--Start Dashboard-->
        <li class="mb-3"><a href="admin-page.php" class="text-decoration-none px-3 py-2 d-block dashbord"><i
                    class="fa-solid fa-home fa-lg"></i> <span class="mx-2">Dashbord</span></a></li>
        <!--End Dashboard-->
        <!--Start Users-->
        <li class="mb-3"><a href="admin-page-request-users.php" class="text-decoration-none
                            px-3 py-2 d-block request-users"> <i class="fa-solid fa-users fa-lg"></i></i>
                <span class="mx-2">Users</span></a></li>
        <!--End Users-->
        <!--Start Grades DropDown-->
        <li class="nav-item dropdown mb-3 w-100 grades"><a href="#" class="nav-link dropdown-toggle text-decoration-none
